...
public class TrocaSenha extends Activity{
    ...
    public class ConnectThread extends Thread{
    	...
    	public void run(){
           ...
           if(Status == ConnectStatus.DISCONNECTED){  //Só envia o pedido de conexão se o mesmo não tiver sido enviado ainda
    	      str = MainActivity.COM_SET_PASS + MainActivity.END_FLAG;//pedido troca de senha
    	      ...
    	      str = _PassWord + MainActivity.END_FLAG;//envia a nova senha
    	      transfer.write(str.getBytes());        //Envia Pedido de conexão ao terminal do dispositivo
    	      try {
    		    sleep(300);
    	      } catch (InterruptedException e) {}
           ...
           String str1 = "";
           String str2 = "";
           if ((str.length() > MainActivity.PASS_CHANGED_OK.length())||(str.length() == MainActivity.PASS_CHANGED_OK.length())){
                 str1 = new String(str.getBytes(),0,MainActivity.PASS_CHANGED_OK.length());                 
           }                           
           
           if(str2.equals(MainActivity.AUTENTICATION_FAIL)){
        	       Status = ConnectStatus.DISCONNECTED;
           }else
           if(str1.equals(MainActivity.PASS_CHANGED_OK)){
           ...
           runOnUiThread(new Runnable(){
    		     ...
    		     public void run() {		    	 			       	 			   			   			   				   
    			      if(Status == ConnectStatus.CONNECTED){	
    			    	  ...
    			    	  ErrorMessage(MainActivity.OPERATION_FAIL);
